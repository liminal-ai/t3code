...
export type DesktopUpdateChannel = "latest" | "nightly" | "ccode-long";
export type DesktopAppStageLabel = "Alpha" | "Dev" | "Nightly" | "Test";
...
export const DesktopUpdateChannelSchema = Schema.Literals(["latest", "nightly", "ccode-long"]);
export const DesktopAppStageLabelSchema = Schema.Literals(["Alpha", "Dev", "Nightly", "Test"]);
