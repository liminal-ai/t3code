...
export function AddProviderInstanceDialog({
  ...
  const handleSave = () => {
    ...
    try {
      ...
      toastManager.add({
        type: "error",
        title: "Could not add Claude instance",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPopup className="max-w-xl overflow-hidden">
        <div className="flex min-h-0 flex-col overflow-hidden">
          <DialogHeader>
            <DialogTitle>Add Claude instance</DialogTitle>
            <DialogDescription>
              Configure an additional Claude instance on {environmentLabel}, for example a work
              account with its own binary or environment.
            </DialogDescription>
